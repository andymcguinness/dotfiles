...
hi NonText		guifg=#12384B					gui=NONE	ctermfg=235

hi Cursor		guifg=NONE		guibg=#8BA7A7
hi LineNr		guifg=#B0B3B9					gui=bold	ctermfg=darkgray						cterm=bold

hi VertSplit	guifg=#F8F8F8	guibg=#0F2130	gui=NONE	ctermfg=234		ctermbg=234	cterm=NONE

hi Visual		guibg=#B0C3DA														ctermbg=236
...
if version >= 700 " Vim 7 specific colors
  hi CursorLine					guibg=#0F2130										ctermbg=234	cterm=NONE
...
hi Identifier	guifg=#f1994a									ctermfg=cyan						cterm=none	
...
hi Directory	guifg=#8A95A7 gui=NONE			ctermfg=yellow	cterm=NONE
